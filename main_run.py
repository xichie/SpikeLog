...
from logadempirical.prolog import run_prolog
...
def arg_parser():
    ...
    parser.add_argument("--num_candidates", default=10, type=int, help="top g candidates are normal")
...
def main():
    ...
    # options["model_path"] = options["model_dir"] + options["model_name"] + "_90.pth" # prolog
    options["model_path"] = options["model_dir"] + options["model_name"] + "_10.pth"
