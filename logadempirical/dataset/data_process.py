...
def process_dataset(data_dir, output_dir, log_file, dataset_name, window_type, window_size, step_size, train_size,
    ...
    if window_type == "sliding":
        ...
        if dataset_name == "hdfs":
            ...
            # window_df = shuffle(window_df).reset_index(drop=True)
            print('window_df len: ', len(window_df))
            n_train = int(len(window_df) * train_size)
...
if __name__ == '__main__':
    process_dataset(data_dir="../../dataset/parsed_dataset/dataset/hdfs/", output_dir="../../dataset/parsed_dataset/dataset/hdfs/", log_file="HDFS.log", dataset_name="hdfs",
                    window_type="session", window_size=20, step_size=60, train_size=0.8, random_sample=False,
                    session_type="entry")